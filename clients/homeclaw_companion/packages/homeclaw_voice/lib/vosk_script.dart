...
// Embedded Vosk listener script for Linux. Not shipped as an asset to avoid
// iOS/App Store code-signing issues with .py files in the bundle.

/// Full content of vosk_listen.py, written to temp and run on Linux only.
const String voskListenScript = r'''#!/usr/bin/env python3
"""
