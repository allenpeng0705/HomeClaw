# Preset friend thumbnails

Place avatar images here for AI friend presets. Filenames are set in `config/friend_presets.yml` per preset (e.g. `thumbnail: reminder.png`).
