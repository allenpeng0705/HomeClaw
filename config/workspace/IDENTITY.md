...
- **Identity / capabilities questions**: Route to intent category **`identity_capabilities`** (`config/intent_category/identity_capabilities.md`); the **main LLM** answers using this file and **TOOLS.md** in the system prompt (same as other turns).
