...
**Mix mode (local vs cloud):** use **`docs/mix-mode-and-reports.md`**, **`LlmConfigCloudAndMixModeReview.md`**, **`HybridLocalCloudLLM.md`**, and **`PlannerExecutorAndDAG.md`**. Older one-off mix/fallback review notes were removed from this folder to avoid duplicate/conflicting guidance.
