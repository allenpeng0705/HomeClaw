...
Run: python -m examples.external_plugins.companion.server
Then register with Core: python -m examples.external_plugins.companion.register
"""
import os
import sys
...
from examples.external_plugins.companion import store
