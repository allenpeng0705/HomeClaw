...
Config: vectorDB.backend: pinecone, vectorDB.Pinecone: { api_key, environment, index_name }
"""
...
_NOT_IMPL = (
    "Pinecone backend is not implemented yet. "
    "Set vectorDB.backend to 'chroma' or 'qdrant' in core.yml, "
    "or implement memory/vector_stores/pinecone_store.py (see qdrant_store.py)."
)
