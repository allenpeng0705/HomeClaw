...
ROUTE_FACTORIES = [
    ...
    ("misc_api", "get_api_skills_list_handler", ()),
    ("misc_api", "get_api_skills_search_handler", ()),
    ("misc_api", "get_api_skills_install_handler", ()),
    ("misc_api", "get_api_skills_remove_handler", ()),
